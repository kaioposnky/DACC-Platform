      ...
      <Card className="overflow-hidden h-full hover:shadow-xl transition-shadow duration-300 !p-0">
        ...
        <div className="p-6 h-full">
          ...
          <div className="flex items-center justify-between mb-4">
            ...
            <span className={`px-3 py-1 rounded-full text-sm font-medium ${getCategoryColor(news.categoryName || news.category?.name || "Geral")}`}>
              {news.categoryName || news.category?.name || "Geral"}
            </span>
          </div>
